...
import com.barkov.ais.cvgram.ViewCvActivity;
...
public class EmployerCvsAdapter extends BaseHttpAdapter {

    Context mContext;
    protected List<CvInfo> cvs;
    protected HashMap<String, Object> hm;
    public EmployerCvsAdapter(Context context) {
        hm = new HashMap<>();
        mContext = context;
        getData();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        cvsView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, ViewCvActivity.class);
    ...
    public boolean getData(Integer...params)
    {
        ...
        try {
            dataProvider.searchCvs(this.hm, this);
        } catch (Exception e) {
            e.printStackTrace();
            setReady();
            return  false;
    ...
    public void setFilters(HashMap<String, Object> hm)
    {
        this.hm = hm;
    }
}
